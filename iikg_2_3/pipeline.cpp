...
void Pipeline::InitPerspectiveProj(Matrix4f& m) const // проецирование перспектив
{
...
const Matrix4f* Pipeline::GetTrans() /*инициализирует три отдельные матрицы для преобразования с текущими параметрами, 
                                     умножает их одну за другой и выводит итоговый результат*/
{
    ...
    m_transformation = PersProjTrans * TranslationTrans * RotateTrans * ScaleTrans; // генерирование итогового преобразования
